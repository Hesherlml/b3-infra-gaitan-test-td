...
class TestCart(unittest.TestCase):
    ...
    def test_apply_valid_discount_code(self):
        ...
        print(f"Total avant réduction : {total_before_discount}")
        print(f"Total après réduction : {total_after_discount}")
    ...
    def test_apply_invalid_discount_code(self):
        ...
        print("Test: Application d'un code promo invalide")
        with self.assertRaises(ValueError) as context:
            self.cart.apply_discount_code("INVALID_CODE")

        # Vérification du message d'erreur
        print(f"Message d'erreur: {context.exception}")
    ...
    def test_no_discount_code(self):
        ...
        print("Test: Vérification du total sans code promo")
        
        total = self.cart.calculate_total()
        print(f"Total actuel sans code promo: {total}")
